...
The generated resources and templates are part of the OpenSDN Python
...
With OpenSDN service templates Version 2, the user can create ports and
...
template are directly visible to the OpenSDN Heat engine, and are
